...
const About = () => {
  return (
    <div className="min-h-screen bg-gray-100 py-8 sm:py-10 px-3 sm:px-6 lg:px-20">
      <div className="max-w-5xl mx-auto bg-white rounded-xl sm:rounded-2xl shadow-lg p-5 sm:p-8 space-y-6 sm:space-y-8">
        ...
        <div className="text-center pt-4 sm:pt-8">
          <h3 className="text-base sm:text-lg md:text-xl font-semibold text-red-600 mb-2">
          ...
          <Link to={"/products"}>
            <button className="bg-red-600 text-white px-5 sm:px-6 py-2 rounded-lg sm:rounded-xl hover:bg-red-700 transition duration-300 text-sm sm:text-base">
              Start Shopping
            </button>
          </Link>
        </div>
